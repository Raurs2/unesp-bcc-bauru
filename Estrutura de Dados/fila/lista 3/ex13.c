...
do
    {
        ...
        } else if (op == 4)
        {
            ...
            if (c1)
            {
                printf("Caixa 1 precisou fazer hora extra (%dseg) para terminar ultimo atendimento\n", c1);
            } 
            if (c2)
            {
                printf("Caixa 2 precisou fazer hora extra (%dseg) para terminar ultimo atendimento\n", c2);
            } 
            if (c3)
            {   
                printf("Caixa 3 precisou fazer hora extra (%dseg) para terminar ultimo atendimento\n", c3);
            } 

...
int estritamente(def_arvore A){
     if (A==NULL) return 0;
     if(A->esq == NULL && A->dir == NULL) return 1;
     if(A->esq != NULL && A->dir != NULL) return (estritamente(A->esq)&&estritamente(A->dir));
     return 0;
}
...
int main(void){
     ...
     if(estritamente(arvore))printf("\nEstritamente binaria");
     else printf("\n Nao Estritamente binaria");

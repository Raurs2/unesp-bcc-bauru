...
int empilha (def_pilha *pilha, int Elemento){
    // retorna se foi possível (1) ou não empilhar o ELEMENTO e atualiza o valor de PILHA->TOPO  
...
int desempilha (def_pilha *pilha,int *Elemento){
    // retorna se foi possível (1) ou não desempilhar o ELEMENTO e atualiza o valor de PILHA->TOPO 

...
int meio_quadrado(int key, int table_digits)
{
    ...
    for ( i = key_digits/2 - 1; i < key_digits/2 + table_digits; i++, j--)
    {
...
int main()
{
    ...
    do
    {
        ...
        //Se a chave for menor do que 999 ele usara o metodo meio quadrado e tratara as colisoes pelo encadeamento interior
        if (func == 1)
        {
        ...
        } else //Se a chave for maior do que 999 ele usara o metodo enlacamento deslocado e tratara as colisoes pela tentativa linear
        {

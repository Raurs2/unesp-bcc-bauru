...
int main() {
    ...
    do
    {
        ...
        if (op3) { 
            ...
            {
                    if (n > 3.14 && n < 3.15) printf("Cossecante de %.2lf = indeterminado(divisao por 0)\n\n", n);
            ...
            } else if (op == 7)
            {
                    ...
                    else if (op2 == 1) printf("Arco Seno de %.2lf = %d\n\n", n, (int)(asin(n)*180/M_PI));
            ...
            } else if (op == 8)
            {
                    ...
                    else if (op2 == 1) printf("Arco cosseno de %.2lf = %d\n\n", n, (int)(acos(n)*180/M_PI));
